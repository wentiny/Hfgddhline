...
/**
 * Created by wentiny on 2019/8/6.
 */
    ...
    private void setSheetItems() {
        ...
        for (int i = 1; i <= size; i++) {
            ...
            if (color == null) {
                ...
                //
                textView.setBackgroundResource(R.mipmap.bg_white);
            }
            // 高度
            float scale = context.getResources().getDisplayMetrics().density;
            int height = (int) (45 * scale + 0.5f);
            textView.setLayoutParams(new WindowManager.LayoutParams(WindowManager.LayoutParams.MATCH_PARENT, height*2));
            // 点击事件
